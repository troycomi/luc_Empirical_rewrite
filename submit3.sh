...
export INPUT_GZ_FILE1=ALL.chr1.phase3_shapeit2_mvncall_integrated_v5a.20130502.genotypes.vcf.gz
export INPUT_GZ_FILE2=ALL.chr1.phase3_shapeit2_mvncall_integrated_v5a.20130502.genotypes.vcf.gz
export TABIX_RANGE=1:1-250000000
export ARCHAIC_VCF=Altai_chr1_new.recode.vcf
export OUTPUT_FILE=Altainew_1KGP3_chr1_3.txt
